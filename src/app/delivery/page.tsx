          ...
          <div>
            ...
            <div className="">
              <ul className="list-disc flex flex-col gap-1 ml-5 xs:ml-8 sm:ml-10">
                ...
                <li>Доставка PostNL (Доставка в течении 1-3 дней. Стоимость доставки 7 EUR.)</li>
                {/* <li>
                ...
                <li>
                  ...
                  заказа. Стоимость доставки 10 EUR.)
                </li>
                {/* <li>
          ...
          <div>
            ...
            <div className="">
              <ul className="list-disc flex flex-col gap-1 ml-5 xs:ml-8 sm:ml-10 text-base">
                ...
                <li>Нидерланды (Доставка бесплатная при заказе от 4шт.)</li>
              </ul>
            </div>
          </div>
          {/* <div>
