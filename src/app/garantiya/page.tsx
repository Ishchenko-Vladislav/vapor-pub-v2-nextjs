      ...
      <div className="max-w-6xl w-full mx-auto px-2">
        <div className="pb-20">
          ...
          <div>
            ...
            <div className="">
              <ul className="list-disc flex flex-col gap-1 ml-5 xs:ml-8 sm:ml-10">
                <li>одноразовые на 1500/2000 тяг (гарантия 3 часа с момента покупки);</li>
                <li>одноразовые на 3000-5000 тяг (гарантия 3 дня с момента покупки);</li>
                <li>одноразовые на 7000 тяг (гарантия 7 дней с момента покупки);</li>
                <li>
                  девайсы, которые не имеют внешних повреждений и не залиты жидкостью (гарантия 14
                  дней с момента покупки). Должно быть наличие полной комплектации.
                </li>
              </ul>
            </div>
          </div>
          <div>
            ...
            <div className="">
              <ul className="list-disc flex flex-col gap-1 ml-5 xs:ml-8 sm:ml-10">
                <li>
                  обмен и возврат возможно осуществить только в течение 14 дней с момента покупки
                  устройства;
                </li>
